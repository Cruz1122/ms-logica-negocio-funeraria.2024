...
export class ServicioPlanController {
  ...
  @get('/servicios/{id}/plans', {
    responses: {
      '200': {
        description: 'Array of Servicio has many Plan through PlanxServicio',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.servicioRepository.planes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.servicioRepository.planes(id).create(plan);
  }
  ...
  async patch(
    ...
    return this.servicioRepository.planes(id).patch(plan, where);
  }
  ...
  async delete(
    ...
    return this.servicioRepository.planes(id).delete(where);
  }
}
